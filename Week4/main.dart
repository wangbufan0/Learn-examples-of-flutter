...
import 'package:flutter_to_bative/bloc/counter_event.dart';
import 'package:flutter_to_bative/jump_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _goMain() {
    ...
    Navigator.of(context)
        .pushReplacement(MaterialPageRoute(builder: (context) => JumpPage()));
  }
